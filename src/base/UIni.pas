...
type
  TSortingType = (sEdition, sGenre, sLanguage, sFolder, sTitle, sArtist, sYear, sDecade, sRecents, sLastAdded);
...
const
  ...
  IJukeboxOrderMode:      array[0..9] of UTF8String = ('Edition', 'Genre', 'Language', 'Folder', 'Title', 'Artist', 'Year', 'Decade', 'Recents', 'LastAdded');
